...
Written for a Teensy2 ++, but should be able to be used unmodified on any AVR-based arduino core with PORTB

PORT B is used for primary IO to device

AVR side                        AT17C65
 B0 = SDA - bidirectional       Pin 1 DATA		4.7k to DATA_PU_PIN
 B1 = SCL - output              Pin 2 CLK 		4.7k to VCC
 B2 = SER_EN - output           Pin 7 /SER_IN
 B3 = CS - output               Pin 4 /CE
 B4 = RESET/OE - output         Pin 3 RESET//OE
                                Pin 6 /CEO/A2   4.7k to GND

                                PIN 5 GND 
(teensy2++) D0                  PIN 8 VCC
(teensy2++) E7                  4.7k to PIN 1                 
*/
